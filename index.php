...
if ($COMMAND == 'READ'){
	...
	EZE_DBS_HELPER('ReadDBPS', 'EZE-DATABASE-HELPER-BETA.php', '/test-database.php', '', '', '', '', '', $EZECORES_Run_Debug_Mode . $EZECORES_Run_Debug_MTP);
...
if ($COMMAND == 'WRITE'){
	...
	EZE_DBS_HELPER('AddDBP', 'EZE-DATABASE-HELPER-BETA.php', '/test-database.php', $NEWSECTORS, '', '', '', '', $EZECORES_Run_Debug_Mode . $EZECORES_Run_Debug_MTP);
...
if ($COMMAND == 'UPDATE'){
	...
	EZE_DBS_HELPER('UpdateDBPS', 'EZE-DATABASE-HELPER-BETA.php', '/test-database.php', $FIRSTSECTOR, $FINDSECTORS, $REPLACESECTORS, '', '', $EZECORES_Run_Debug_Mode . $EZECORES_Run_Debug_MTP);
